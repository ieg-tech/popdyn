...
def no_species():
    ...
    with popdyn.Domain('seven_kingdoms.popdyn', csx=1., csy=1., shape=(1, 1), top=1, left=0) as domain:
        solvers.discrete_explicit(domain, 0, 1)
...
if __name__ == '__main__':
    ...
    try:
        no_species()
        print("Incorrect species addition test: FAIL:\nNo Exception raised")
    except Exception as e:
        if isinstance(e, solvers.SolverError):
            print("Incorrect species addition test: PASS")
        else:
            print("Incorrect species addition test: FAIL:\n{}".format(e))
    print("")
    ...
    try:
        incorrect_ages()
        print("Incorrect age group test: FAIL:\nNo Exception raised")
    except Exception as e:
        if isinstance(e, solvers.SolverError):
            print("Incorrect age group test: PASS")
        else:
            print("Incorrect age group test: FAIL:\n{}".format(e))
    print("")
    os.remove('seven_kingdoms.popdyn')
    ...
    try:
        incorrect_species()
        print("Incorrect species available test: FAIL:\nNo Exception raised")
    except Exception as e:
        if isinstance(e, solvers.SolverError):
            print("Incorrect species available test: PASS")
        else:
            print("Incorrect species available test: FAIL:\n{}".format(e))
    print("")
    os.remove('seven_kingdoms.popdyn')
    ...
    try:
        single_species()
        print("Single species test: PASS")
    except Exception as e:
        print("Single species test: FAIL:\n".format(e))
    os.remove('seven_kingdoms.popdyn')
    ...
    try:
        ...
        print("Single species with randomness test: PASS")
    except Exception as e:
        print("Single species with randomness test: FAIL:\n".format(e))
    os.remove('seven_kingdoms.popdyn')

    #   ...add dispersion
    # ============================================================================
    # try:
    #     single_species_random_dispersion()
    #     print("Single species with randomness and dispersion test: PASS")
    # except Exception as e:
    #     print("Single species with randomness and dispersion test: FAIL:\n".format(e))
    # os.remove('seven_kingdoms.popdyn')
    #
    # #   ...add age groups
    # # ============================================================================
